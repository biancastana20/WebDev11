...
const hiddenPart = document.querySelector(".box-agendaTable");

button.addEventListener("click", addContact);

function addContact() {
  //add row to initial table and cells
