const out = document.getElementById("addfname"); // var out for adding fname to banner after submitt
const y = document.querySelector(".hidebanner"); //var y for banner witch is hide initially
